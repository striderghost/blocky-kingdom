...
public class GoblinFang extends CustomItem{
	
	public static final String NAME = ChatColor.YELLOW + "Goblin Fang";
	public static final String IDENTIFIER = "goblin_fang";
